...
const Icons = (() => {
    ...
    const lib = {
        ...
        speakerLoud:  _svg('<polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14"/><path d="M15.54 8.46a5 5 0 0 1 0 7.07"/>'),
        speakerEar:   _svg('<path d="M12 1c-4.97 0-9 4.03-9 9 0 2.38.93 4.55 2.44 6.16L7 19h10l1.56-2.84C20.07 14.55 21 12.38 21 10c0-4.97-4.03-9-9-9zm0 4c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 14c-2 0-3.78-.9-5-2.3.43-.7 1.2-1.2 2.1-1.2h5.8c.9 0 1.67.5 2.1 1.2C17.78 22.1 16 23 14 23z"/>'),
        screenShare:  _svg('<path d="M2 12.42V19a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6.58"/><polyline points="7 9 12 4 17 9"/><line x1="12" y1="4" x2="12" y2="16"/>'),
        addUser:      _svg('<path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="8.5" cy="7" r="4"/><line x1="20" y1="8" x2="20" y2="14"/><line x1="23" y1="11" x2="17" y2="11"/>'),
